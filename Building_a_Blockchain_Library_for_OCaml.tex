\documentclass[12pt,a4paper,twoside,openright]{report}
	...
	\begin{figure}
		\begin{center}
			\begin{tikzpicture}[
				gennode/.style={rectangle, draw=black!60, fill=cyan!100, very thick, minimum size=5mm},
				mainnode/.style={rectangle, draw=black!60, fill=black!100, very thick, minimum size=5mm},
				subnode/.style={rectangle, draw=black!60, fill=purple!100, very thick, minimum size=5mm},
			]
