...
let rec start_leader () = 
	...
	This thread takes the blockchain \texttt{cache} branch and use this to create a new \texttt{push-cache} branch which it pushes to replicas.
	...
	\begin{figure}
		...
		\begin{tikzpicture}[
			...
			\node[block] (block3) [right=of block2] {};
			\node[block] (block4) [right=of block3] {};
			\node[label] (labelpushcache) [below=of block3] {\texttt{push-cache} branch};
			\node[block] (block5) [right=of block4] {};
			\node[label] (labelcache) [above=of block5] {\texttt{cache} branch};
		...
		\begin{tikzpicture}[
			...
			\node[label] (labelpushcache) [below=of block5] {\texttt{push-cache} branch};
			\node[block] (block5) [right=of block4] {};
			\node[label] (labelcache) [above=of block5] {\texttt{cache} branch};
