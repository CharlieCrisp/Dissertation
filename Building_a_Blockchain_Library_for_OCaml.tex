...
{ time    : Time.t;
  ...
  prev    : K.t option}
	...
	Logan uses a mempool and a simple leader-based algorithm that is inspired by the previously described consensus protocols, and in this section I will describe the roles of nodes in a Logan network.
