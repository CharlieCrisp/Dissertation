...
let rec start_leader () = 
	...
	Overall, in the case of a single remote Participant, Logan is able to comfortably reach throughputs of up to 40 transactions per second which is much above the success criteria. 
	Latencies in this case are initially less than 10s which is a good result for most applications.
