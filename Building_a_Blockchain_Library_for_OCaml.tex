...
module Make(Config: I_Config): I_Blockchain with type t = Config.t = struct 
  ...
	...
	The library uses a leader based consensus protocol inspired by Raft also uses the concept of a `transaction waiting room', or \textit{mempool}, which is used by Bitcoin.
...
{ time    : Time.t;
  ...
  prev    : K.t option}
	...
	This is not desirable behaviour for a blockchain, so I have ensured that the blockchain data structure is never merged with other structures, only appended to. 
	...
	In this section I will investigate the semantics of Ezirmin merges as they are critical to understanding how consensus is achieved in this project.\\
