...
latest_known_cursor := get_new_latest_cursor;;
	...
	Figure \ref{fig:singlocal} shows that the latency is extremely low and varies little with increased throughput. 
	There is a bottleneck in how fast the Participant can write transactions into the mempool and this means the system never becomes overloaded.
	\begin{figure}
		\centering
		...
		\label{fig:singlocal}
	\end{figure}
	Figure \ref{fig:locallatency} shows that the latency stays constant with the number of items in the blockchain.
	\begin{figure}
		\centering
