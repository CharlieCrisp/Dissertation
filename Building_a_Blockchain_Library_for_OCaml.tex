...
latest_known_cursor := get_new_latest_cursor;;
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{figs/single_local_worker.png}
		\caption{Latency variation with throughput on a single local Participant}
		\label{figs:singlocal}
	\end{figure}
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{figs/latency_vs_size.png}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{figs/single_remote_worker.png}
