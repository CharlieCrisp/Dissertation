...
module Make(Config: I_Config): I_Blockchain with type t = Config.t = struct 
  ...
	...
	\begin{itemize}
		...
		\item The system should be capable of handling throughputs of at least 10 transactions per second, with the latency of making a transaction being less than 10 seconds.s
...
let rec start_leader () = 
	...
	All following measurements of throughput will be in transactions per second unless otherwise stated.
	...
	However, despite these machine limitations, these figures are much better than my success criteria which suggested the system should be able to function with throughputs greater than 10, and with latencies of less than 10 seconds.\\
	\begin{figure}
		\centering
	...
	Importantly, these teeth are relatively small up until around 40 transactions per second.
	...
	At a mempool size of 5000 and a throughput of 10, latencies have been reduced from 15 seconds (with OCaml Git) to 8 (with pure Git).
	This result shows that in this scenario, Logan still satisfies the success criteria of being able to acheive throughputs greater than 10 and latencies less than 10 seconds.
	\begin{figure}
		\centering
	...
	Whilst I have now shown that Logan can perform better by using pure Git, there is still the unfortunate result that transaction latencies increase linearly with the size of the mempool being pulled.
