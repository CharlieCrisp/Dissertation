			...
			\begin{figure}
				...
				\begin{subfigure}[b]{0.45\textwidth}
					...
					\begin{tikzpicture}[
						...
						label/.style={rectangle, minimum size = 7mm, text width=1.7cm}
					]
				...
				\label{fig:readremotepartudpates1}
				\end{subfigure}
				\begin{subfigure}[b]{0.45\textwidth}
					\centering
						\begin{tikzpicture}[
						...
						\end{tikzpicture}
					\caption{After merge}
					\label{fig:readremotepartudpates2}
					\end{subfigure}
					\caption{Merging mempool updates from remote participant (below) to leader (above)}
			\end{figure}
