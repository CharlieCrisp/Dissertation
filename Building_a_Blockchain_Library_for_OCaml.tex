...
module type FS_Log = sig
  ...
  ...
	...
	In order to see that the second criteria, i.e. that blocks are ordered with each containing the hash of its parent, we must look at the implementation of log items.
